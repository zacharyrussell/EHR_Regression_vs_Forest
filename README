...
Using **synthetic patient data**, we analyze key health indicators such as **age, BMI, past medical history, and hospital visits** to train predictive models. Our findings show that **Random Forest significantly outperforms Logistic Regression** in this task.
...
- **Feature dependencies** – The impact of BMI on diabetes risk changes with age.
